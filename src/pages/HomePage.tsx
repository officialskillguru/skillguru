    ...
    <main className="page-shell overflow-x-clip">
        ...
        <div className="hero-content relative z-[3] mx-auto flex h-full max-w-[1440px] items-center px-4 sm:px-6 lg:px-8">
          <div className="hero-copy relative z-10 w-full">
            <p className="hero-trust-badge inline-flex items-center gap-2.5 rounded-full border border-[#168CFF]/55 bg-[#062B58]/55 px-5 py-2 text-[11px] font-black uppercase tracking-[0.2em] text-white shadow-[inset_0_0_14px_rgba(25,217,255,0.08),0_0_20px_rgba(17,71,255,0.18)] backdrop-blur-sm">
              <ShieldCheck className="size-3.5 text-[#19C7C8]" />
            ...
            <h1 className="hero-heading font-[900] text-white [text-shadow:0_4px_24px_rgba(2,8,23,0.62)]">
              ...
              <span className="block bg-gradient-to-r from-[#9E8CFB] via-[#7FB2E8] to-[#19C7C8] bg-clip-text text-transparent">
                Skills create
              </span>
              <span className="block bg-gradient-to-r from-[#9E8CFB] via-[#7FB2E8] to-[#19C7C8] bg-clip-text text-transparent">
                careers.
            ...
            <div className="hero-actions flex flex-col gap-4 sm:flex-row">
              <Link
                ...
                className="inline-flex h-12 items-center justify-center gap-2 rounded-[12px] border border-white/15 bg-gradient-to-r from-[#19C7C8] to-[#5B35F2] px-7 text-[14px] font-bold text-white shadow-[0_12px_30px_rgba(17,71,255,0.34)] backdrop-blur-md transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_38px_rgba(25,217,255,0.28)]"
              >
      ...
      <section ref={recruiterShellRef} className="recruiter-marquee-section relative z-20 mx-auto mt-10 max-w-[1440px] px-4 sm:px-6 lg:px-8">
        <div className="recruiter-marquee-shell flex flex-col gap-5 overflow-hidden rounded-[24px] border border-white/60 bg-white/78 px-6 py-5 shadow-[0_24px_70px_rgba(10,42,136,0.14)] backdrop-blur-2xl md:flex-row md:items-center">
          <div className="flex shrink-0 items-center md:border-r md:border-[#E5EAF5] md:pr-7">
            <span className="text-[12px] font-black uppercase tracking-[0.18em] text-[#111E79]">Our Top Recruiters</span>
          </div>
          <div className="recruiter-marquee-window min-w-0 flex-1 overflow-hidden md:pl-1">
            <div ref={recruiterTrackRef} className="recruiter-marquee-track flex w-max items-center gap-5">
              {[...recruiters, ...recruiters, ...recruiters].map((partner, index) => (
                <div key={`${partner}-${index}`} className="recruiter-logo-tile grid h-14 w-36 shrink-0 place-items-center rounded-[16px] border border-[#E5EAF5]/80 bg-white/74 px-5 transition duration-300 hover:-translate-y-0.5 hover:border-[#19C7C8]/70 hover:shadow-[0_14px_34px_rgba(25,217,255,0.2)]">
        ...
        <div className="mx-auto max-w-[1440px]">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => {
              ...
              return (
                <article key={stat.label} className="premium-stat-card group relative overflow-hidden rounded-[18px] border border-white/10 bg-white/[0.065] p-6 shadow-[0_20px_70px_rgba(0,0,0,0.24)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-[#19C7C8]/45 hover:bg-white/[0.09] hover:shadow-[0_24px_78px_rgba(25,217,255,0.12)]">
                  <span className="relative z-10 grid size-12 place-items-center rounded-[14px] border border-[#19C7C8]/25 bg-[#19C7C8]/10 text-[#19C7C8] shadow-[0_0_24px_rgba(25,217,255,0.14)] transition duration-300 group-hover:scale-105 group-hover:shadow-[0_0_34px_rgba(25,217,255,0.24)]">
      ...
      <section className="bg-[#F8FAFF] px-4 py-12 sm:px-6 lg:px-8 lg:py-[100px]">
        <div className="mx-auto max-w-[1280px]">
          <GsapReveal className="text-center">
            <p className="text-xs font-black uppercase tracking-[0.22em] text-[#5B35F2]">Why Choose SkillGuru</p>
            <h2 className="mt-4 text-3xl font-black text-[#111E79] sm:text-5xl">We Don&apos;t Just Teach. We Transform</h2>
          </GsapReveal>
          <GsapReveal stagger className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {whyChooseUs.map((item) => {
              const Icon = item.icon;
              return (
                <article key={item.title} className="premium-surface rounded-[20px] border border-[#E5EAF5] bg-white p-6 shadow-[0_16px_50px_rgba(10,42,136,0.08)] transition duration-300 hover:-translate-y-1 hover:border-[#19C7C8]/45 hover:shadow-[0_22px_66px_rgba(17,71,255,0.13)]">
                  <span className="grid size-12 place-items-center rounded-[14px] bg-[#F1F5FF] text-[#5B35F2]">
                    <Icon className="size-6" />
                  </span>
                  <h3 className="mt-5 text-lg font-black text-[#111E79]">{item.title}</h3>
      ...
      <section className="bg-white px-4 py-12 sm:px-6 lg:px-8 lg:py-[100px]">
        <div className="mx-auto max-w-[1280px]">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.22em] text-[#5B35F2]">Explore Courses</p>
              <h2 className="mt-4 text-3xl font-black text-[#111E79] sm:text-5xl">Industry-Relevant Courses</h2>
            ...
            <Link to={routes.courses} className="inline-flex items-center gap-2 text-sm font-black text-[#5B35F2]">
      ...
      <section className="bg-[#F8FAFF] px-4 py-12 sm:px-6 lg:px-8">
        <div className="premium-surface mx-auto max-w-[1280px] rounded-[20px] border border-[#E5EAF5] bg-white p-7 shadow-[0_18px_60px_rgba(10,42,136,0.08)]">
          <p className="text-center text-sm font-black text-[#111E79]">Top Hiring Partners</p>
      ...
      <section className="bg-white px-4 py-12 sm:px-6 lg:px-8 lg:py-[100px]">
        <div className="mx-auto max-w-[1280px]">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-start">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.22em] text-[#5B35F2]">Success Stories Preview</p>
              <h2 className="mt-4 text-3xl font-black text-[#111E79] sm:text-5xl">From Learners to Achievers</h2>
              <GsapReveal stagger className="mt-8 grid gap-5 md:grid-cols-2">
                {successStories.slice(0, 2).map((story) => (
                  <article key={story.name} className="premium-surface rounded-[20px] border border-[#E5EAF5] bg-white p-5 shadow-[0_18px_55px_rgba(10,42,136,0.08)] transition duration-300 hover:-translate-y-1 hover:border-[#19C7C8]/45 hover:shadow-[0_24px_72px_rgba(17,71,255,0.13)]">
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-[#5B35F2]">{story.role}</p>
            ...
            <div>
              <p className="text-xs font-black uppercase tracking-[0.22em] text-[#5B35F2]">Mentor Preview</p>
              <h2 className="mt-4 text-3xl font-black text-[#111E79]">Featured Mentors</h2>
      ...
      <section className="bg-[#F8FAFF] px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-[1280px] gap-5 md:grid-cols-3">
          {[
            ...
            const Icon = item.icon;
            return (
              <article key={item.title} className="premium-surface flex items-center gap-4 rounded-[20px] border border-[#E5EAF5] bg-white p-5 shadow-[0_16px_45px_rgba(10,42,136,0.07)] transition duration-300 hover:-translate-y-1 hover:border-[#19C7C8]/45">
                <span className="grid size-12 place-items-center rounded-full bg-[#F1F5FF] text-[#5B35F2]">
                  <Icon className="size-5" />
                </span>
                <span className="font-black text-[#111E79]">{item.title}</span>
              </article>
            );
          })}
        </div>
