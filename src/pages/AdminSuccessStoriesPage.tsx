  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="grid gap-4 grid-cols-2 md:grid-cols-4">
        {[
          { label: "Stories Active", count: stories.length, color: "text-[#0F2B7A]" },
            ...
            <div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <h3 className="text-sm font-black text-[#0F2B7A] dark:text-white">{story.name}</h3>
                    ...
                    {activeMenu === story.name && (
                      <>
                        ...
                        >
                          ...
                          >
                            <Edit2 className="size-3 text-[#0F2B7A]" />
              ...
              <div className="mt-5 grid grid-cols-2 gap-4 rounded-2xl bg-[#EEF3FA]/40 p-4.5 dark:bg-slate-800/40">
                <div className="flex items-center gap-2.5">
                  <Building2 className="size-4.5 text-[#0F2B7A] dark:text-cyan-300 shrink-0" />
                  <div>
                    <p className="text-[9px] font-black uppercase text-slate-400">Corporation</p>
                    <p className="text-xs font-black text-[#0F2B7A] dark:text-slate-200">{story.company}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2.5">
                  <DollarSign className="size-4.5 text-[#0F2B7A] dark:text-cyan-300 shrink-0" />
                  <div>
              ...
              <div className="mt-5 flex items-center gap-3.5 text-[10px] font-black text-slate-400 uppercase tracking-wider">
                ...
                <span className="text-[#0F2B7A] dark:text-cyan-300">{story.after}</span>
              </div>
              ...
              <div className="mt-4 relative bg-slate-50 p-4 rounded-2xl border border-slate-100 dark:bg-slate-900/60 dark:border-slate-850">
                <Quote className="absolute right-3.5 top-3.5 size-4 text-[#0F2B7A]/10 dark:text-cyan-300/10" />
                <p className="text-xs font-bold text-slate-500 dark:text-slate-400 leading-relaxed italic pr-4">
                  "{story.quote || "The placement support at HR Remedy India Education assisted me at each transition phase. Clear mock sessions and resume endorsements guaranteed success."}"
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="fixed inset-0 z-50 grid place-items-center bg-[#020617]/50 p-4 backdrop-blur-sm">
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-4 dark:border-slate-800">
                <h3 className="text-lg font-black text-[#0F2B7A] dark:text-white">Success Record Sheet</h3>
                <button
              ...
              <form onSubmit={saveStory} className="mt-5 space-y-4 max-h-[60svh] overflow-y-auto pr-1">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-1">
                    <label className="text-xs font-black text-[#0F2B7A] dark:text-slate-350">Placed Corporate Partner</label>
                    <input
                      required
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-black text-[#0F2B7A] dark:text-slate-350">Compensation Package (LPA)</label>
                    <input
                      required
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-1">
                    <label className="text-xs font-black text-[#0F2B7A] dark:text-slate-350">State Prior (Before)</label>
                    <input
                      required
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-black text-[#0F2B7A] dark:text-slate-350">Placed Role (After)</label>
                    <input
                      required
                ...
                <div className="space-y-1">
                  <label className="text-xs font-black text-[#0F2B7A] dark:text-slate-350">Review Endorsement Quote</label>
                  <textarea
                    rows={3}
                ...
                <div className="space-y-3 rounded-2xl border border-dashed border-slate-200 p-4 bg-slate-50 dark:border-slate-800 dark:bg-slate-900">
                  <p className="text-xs font-black text-[#0F2B7A] dark:text-cyan-300">Placement Roadmap Audit</p>
                  <div className="flex items-center gap-2 text-[10px] font-bold text-slate-400">
                    <span>Enrolled</span>
                    <ArrowRight className="size-3" />
                    <span className="text-[#0F2B7A] dark:text-cyan-400">Mock Cleared</span>
                    <ArrowRight className="size-3" />
                    <span className="text-[#0F2B7A] dark:text-cyan-400">Interviews</span>
                    <ArrowRight className="size-3" />
