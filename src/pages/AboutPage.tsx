    ...
    <main className="page-shell">
      <section className="bg-white px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            <h1 className="text-4xl font-black leading-tight text-[#111E79] sm:text-6xl">Empowering India&apos;s Career Transformation</h1>
              ...
              {stats.map((stat) => {
                ...
                return (
                  <div key={stat.label} className="rounded-2xl border border-[#E5EAF5] bg-white p-4 shadow-[0_14px_40px_rgba(10,42,136,0.07)]">
                    ...
                    <p className="mt-3 text-xl font-black text-[#111E79]">{stat.value.toLocaleString("en-IN")}{stat.suffix}</p>
          ...
          <div className="relative min-h-90 overflow-hidden rounded-3xl border border-[#E5EAF5] bg-[linear-gradient(135deg,#F8FAFF,#FFFFFF)] shadow-[0_24px_80px_rgba(10,42,136,0.10)]">
            <div className="absolute inset-x-10 bottom-0 h-64 rounded-t-[28px] bg-linear-to-br from-[#111E79] to-[#5B35F2]" />
            ...
            <div className="absolute right-8 top-8 rounded-2xl bg-white p-5 shadow-[0_18px_55px_rgba(10,42,136,0.12)]">
              <Building2 className="size-8 text-[#5B35F2]" />
              <p className="mt-3 text-sm font-black text-[#111E79]">Career Campus</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#F8FAFF] px-4 py-12 sm:px-6 lg:px-8 lg:py-25">
        <div className="mx-auto max-w-7xl">
          <p className="text-center text-xs font-black uppercase tracking-[0.22em] text-[#5B35F2]">Our Journey</p>
          <h2 className="mt-4 text-center text-3xl font-black text-[#111E79] sm:text-5xl">Built Around Learner Outcomes</h2>
          <div className="mt-12 grid gap-5 md:grid-cols-5">
            {journey.map(([year, title, body], index) => (
              <article key={year} className="relative rounded-lg border border-[#E5EAF5] bg-white p-5 text-center shadow-[0_16px_45px_rgba(10,42,136,0.07)]">
                <span className="mx-auto grid size-12 place-items-center rounded-full bg-[#5B35F2] text-sm font-black text-white">{index + 1}</span>
                <p className="mt-4 text-lg font-black text-[#111E79]">{year}</p>
                <h3 className="mt-2 font-black text-[#111E79]">{title}</h3>
      ...
      <section className="bg-[#F8FAFF] px-4 py-12 sm:px-6 lg:px-8 lg:py-25">
        <div className="mx-auto max-w-7xl">
          <p className="text-xs font-black uppercase tracking-[0.22em] text-[#5B35F2]">Leadership Team</p>
          <h2 className="mt-4 text-3xl font-black text-[#111E79] sm:text-5xl">Mentors, Operators, and Career Builders</h2>
      ...
      <section className="bg-white px-4 py-12 sm:px-6 lg:px-8 lg:py-25">
        <div className="mx-auto max-w-7xl">
            ...
            {[
              ...
              return (
                <article key={item.body} className="rounded-lg border border-[#E5EAF5] bg-white p-6 text-center shadow-[0_16px_45px_rgba(10,42,136,0.07)]">
                  <Icon className="mx-auto size-8 text-[#5B35F2]" />
                  <p className="mt-4 text-3xl font-black text-[#111E79]">{item.title}</p>
          ...
          <div className="mt-12 rounded-lg border border-[#E5EAF5] bg-white p-7 shadow-[0_18px_60px_rgba(10,42,136,0.08)]">
            <p className="text-center text-sm font-black text-[#111E79]">Our Top Recruiters</p>
        ...
        <div className="mx-auto grid max-w-7xl gap-5 md:grid-cols-4">
          {valueCards.map((item) => {
            ...
            <article key={item.title} className="rounded-lg border border-[#E5EAF5] bg-white p-6 shadow-[0_16px_45px_rgba(10,42,136,0.07)]">
              <Icon className="size-8 text-[#5B35F2]" />
